...
def kojos_kitchen_simulation(use_extra_employee, log_name, log_file):
    logger = init_logger(log_name, log_file)  #initializing logger
    ...
    while True:
        ...
        if next_arrival != INFINITY and next_arrival == cur_time:
            ...
            elif use_extra_employee and in_busy_hours(t) and who_third == 0:
        ...
        elif use_extra_employee and t_out_3 != INFINITY and t_out_3 == cur_time:
            third_empl_req += 1
            t = t_out_3
            t_out[who_third] = t
...
if __name__ == '__main__':
    two = kojos_kitchen_simulation(False, 'Two Employees Logger', 'two_employees.log')
    three = kojos_kitchen_simulation(True, 'Three Employees Logger', 'three_employees.log')

    print(f'Percent of clients who waited more than 5 minutes (2 employees) = {two}')
    print(f'Percent of clients who waited more than 5 minutes (3 employees) = {three}')
